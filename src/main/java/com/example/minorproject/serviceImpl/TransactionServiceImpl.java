...
//        6) Make the Book Available
        ...
        // Return Transaction
            ...
            //when was the book issued?  select top 1 from transaction where book_id=bookId and student_id=studentId and transaction_type=0 order by transaction_date desc
